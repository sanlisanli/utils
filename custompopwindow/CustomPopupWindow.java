...
public class CustomPopupWindow extends PopupWindow implements PopupWindow.OnDismissListener {
     ...
     * @return
     */
    public CustomPopupWindow displayAsDropDown(View anchor, int xOff, int yOff){
    ...
    public CustomPopupWindow displayAsDropDown(View anchor){
        if(mPopupWindow!=null){
    ...
    public CustomPopupWindow displayAsDropDown(View anchor, int xOff, int yOff, int gravity){
        if(mPopupWindow!=null){
    ...
    public static class PopupWindowBuilder{
        ...
        public PopupWindowBuilder(Context context){
            mCustomPopWindow=new CustomPopupWindow(context);
        }
